...
app.MapGet("/some-data", () => "Hello World!").RequireAuthorization();
...
app.MapGet("/generate-pdf", async (HttpContext context) =>
{
    ...
    var renderer = new ChromePdfRenderer
    {
        ...
        {
            RenderDelay = (int)TimeSpan.FromSeconds(2).TotalMilliseconds
        }
    };

    var pdf = await renderer.RenderUrlAsPdfAsync("http://localhost:5012/");
